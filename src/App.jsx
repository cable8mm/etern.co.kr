...
const faqItems = [
  {
    question: '문서가 없는데 가능한가?',
    answer:
      '가능합니다. 다만 바로 변경하지 않고 소스코드, 데이터베이스, 인프라, 배포 절차를 먼저 분석합니다.',
  },
  {
    question: '개발자가 퇴사했는데 가능한가?',
    answer:
      '가능합니다. 이런 상황이 Technical Assessment의 대표 대상입니다. 접근 권한과 현재 운영 상태를 기준으로 구조를 복원합니다.',
  },
  {
    question: 'PHP5도 가능한가?',
    answer:
      '가능합니다. PHP 5.x, PHP 7.x, CakePHP, CodeIgniter, 자체 프레임워크를 대상으로 현대화 범위와 리스크를 평가합니다.',
  },
  {
    question: '쇼핑몰 이전은 얼마나 걸리나?',
    answer:
      '기간은 데이터 구조, 주문/회원/포인트 정책, 전환 방식에 따라 달라집니다. 먼저 데이터 매핑과 Gap Analysis가 필요합니다.',
  },
  {
    question: '서버 접근 권한이 없어도 가능한가?',
    answer:
      '가능 범위가 제한될 수 있습니다. Git, DB 덤프, 관리자 계정, 호스팅 계정 등 확보 가능한 자산부터 확인합니다.',
  },
  {
    question: '운영 중 서비스도 작업 가능한가?',
    answer:
      '가능합니다. ETERNOps는 운영 중인 시스템을 대상으로 하며, 변경 계획보다 복구 계획을 먼저 준비합니다.',
  },
];
