  ...
  return (
    ...
    >
      ...
      <main>
          ...
          <div className="max-w-4xl mx-auto text-center z-10 w-full">
            ...
            >
              <h1 className="text-4xl md:text-5xl lg:text-[4.5rem] font-extrabold tracking-tight text-slate-900 leading-[1.2] mb-8 break-keep">
                기술로 비즈니스의 문제를 해결하는 <br className="hidden md:block" />
            ...
            >
              25년 이상의 시니어 엔지니어링 전문성을 바탕으로, 탄탄한 클라우드 인프라 위에서 구동되는 스케일러블(Scalable)한 프로덕트를 구축합니다.
            </motion.p>
        ...
        <section id="projects" className="py-24 md:py-32 bg-white px-6 md:px-12">
          <div className="max-w-7xl mx-auto">
            ...
            >
              <h2 className="text-sm font-black text-[#f97316] uppercase tracking-[0.2em] mb-4">Our Products</h2>
              <h3 className="text-3xl md:text-5xl font-extrabold text-slate-900 tracking-tight">핵심 서비스 포트폴리오</h3>
            </motion.div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-10">
              ...
              >
                ...
                <h4 className="text-2xl md:text-3xl font-bold text-slate-900 mb-5 break-keep">QR코드 접속 와이파이 노트</h4>
                <p className="text-slate-600 mb-10 text-lg leading-relaxed flex-grow break-keep">
                  복잡한 비밀번호 입력 없이 QR로 간편하게 접속을 공유하는 웹 및 모바일 앱 서비스
                </p>
                <div className="flex flex-wrap gap-2.5 mb-10">
                  {['Laravel', 'TailwindCSS', 'OpenAI API', 'Gemini Image', 'Swift', 'Kotlin', 'Flutter'].map(tech => (
                    <span key={tech} className="px-4 py-1.5 bg-white text-slate-700 text-sm font-bold rounded-full border border-slate-200 shadow-sm">
                      {tech}
                    </span>
                  ))}
                </div>
              ...
              >
                ...
                <div className="absolute inset-0 bg-white/60 backdrop-blur-sm z-10 flex flex-col items-center justify-center text-slate-700 transition-all duration-300 group-hover:bg-white/50">
                  ...
                  <span className="font-extrabold text-xl tracking-tight">서비스 준비중</span>
                </div>
                ...
                <div className="opacity-40 blur-[1px]">
                  ...
                  <h4 className="text-2xl md:text-3xl font-bold text-slate-900 mb-5 break-keep">스마트 물류 시스템</h4>
        ...
        <section id="footprint" className="py-24 md:py-32 bg-slate-50 px-6 md:px-12 border-t border-slate-100">
          <div className="max-w-7xl mx-auto">
            <motion.div 
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              <h2 className="text-sm font-black text-[#f97316] uppercase tracking-[0.2em] mb-4">Engineering DNA</h2>
              <h3 className="text-3xl md:text-5xl font-extrabold text-slate-900 tracking-tight">기술 풋프린트</h3>
            </motion.div>
              ...
              {[
                ...
                >
                  <div className="w-14 h-14 rounded-2xl bg-slate-50 flex items-center justify-center mb-8 group-hover:bg-[#1a365d] group-hover:scale-110 transition-all duration-300">
                    <item.icon className="text-[#1a365d] group-hover:text-white transition-colors" size={28} />
                  </div>
                  <h4 className="text-2xl font-bold text-slate-900 mb-4">{item.title}</h4>
                  <p className="text-slate-600 mb-8 leading-relaxed break-keep">{item.desc}</p>
        ...
        <section id="infrastructure" className="py-24 md:py-40 bg-[#1a365d] text-white px-6 md:px-12 relative overflow-hidden">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 items-center">
              ...
              >
                <h2 className="text-4xl md:text-5xl lg:text-6xl font-extrabold mb-8 leading-tight tracking-tight break-keep">
                  안정적인 인프라 기반의 <br />
                  <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-300 to-[#f97316]">비즈니스 파트너십</span>
                </h2>
                <p className="text-blue-100/90 text-xl leading-relaxed mb-10 break-keep font-medium">
                  글로벌 트래픽 대응을 위해 AWS의 EC2, RDS 등 강력한 클라우드 인프라 위에서 스케일업을 준비하고 있습니다. 함께 성장할 파트너십을 환영합니다.
                </p>
                <div className="flex flex-wrap items-center gap-4 text-sm font-bold text-white">
                  <div className="px-5 py-2.5 bg-white/10 hover:bg-white/20 transition-colors rounded-full backdrop-blur-sm border border-white/10">AWS EC2</div>
                  <div className="px-5 py-2.5 bg-white/10 hover:bg-white/20 transition-colors rounded-full backdrop-blur-sm border border-white/10">Amazon RDS</div>
                  <div className="px-5 py-2.5 bg-white/10 hover:bg-white/20 transition-colors rounded-full backdrop-blur-sm border border-white/10">Cloud Scale</div>
                </div>
              </motion.div>
              ...
              >
                <div className="bg-white rounded-[2.5rem] p-10 md:p-12 shadow-2xl shadow-black/20 text-slate-900 border border-white/20 relative overflow-hidden group">
                  ...
                  <h3 className="text-3xl font-extrabold mb-4 tracking-tight">프로젝트 문의하기</h3>
                  <p className="text-slate-600 mb-10 text-lg break-keep font-medium">새로운 비즈니스 기회나 기술적 협업이 필요하신가요?</p>
                  ...
                  >
                    ...
                    <div className="text-center sm:text-left">
                      <div className="text-sm font-bold text-slate-500 group-hover/btn:text-blue-200 mb-1 transition-colors uppercase tracking-wider">Email Us</div>
      ...
      <footer className="bg-slate-900 text-slate-400 py-12 px-6 md:px-12 border-t border-white/10 text-center">
        <p className="font-medium text-sm tracking-wide">© 2026 FastCode Inc. All rights reserved.</p>
      </footer>
    </div>
  );
}
